...
Функция СформироватьСтруктуруНоменклатуры(НоменклатураСсылка)
	...
	СтруктураНоменклатуры.Вставить("Наименование", 		НомОбъект.Наименование);
	СтруктураНоменклатуры.Вставить("Тип", 				СпрТипНоменклатуры);
	СтруктураНоменклатуры.Вставить("Родитель", 			ИдГр);
	СтруктураНоменклатуры.Вставить("Артикул", 			Транслит(НомОбъект.Код));
	СтруктураНоменклатуры.Вставить("ЕдиницаИзмерения", 	ИдЕИ);
			...
			Если СтруктураОтвета.Свойство("success") Тогда
				Если СтруктураОтвета.Свойство("resultStatus") Тогда
					Если СтруктураОтвета.success="true" И СтруктураОтвета.resultStatus="SUCCESS" Тогда
						ЗаписатьВЛог("Номенклатура "+СтруктураОбъекта.Наименование+" создана в IIKO. ["+СтруктураОтвета.returnValue+"]");
					Иначе
