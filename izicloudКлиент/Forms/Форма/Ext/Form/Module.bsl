...
Процедура ЗагрузитьГруппыНоменклатурыАйко()
	...
	ТипыОбъектов.Добавить("productGroup");
	СоответствиеПараметров = Новый Соответствие;
	СоответствиеПараметров.Вставить("entity_types", ТипыОбъектов);
	МассивОтвета = ПолучитьДанныеИзIIKO("entity/entities?parameters="+ПреобразоватьСтруктуруВJSONСтроку(СоответствиеПараметров));
	Если МассивОтвета = Неопределено Тогда
